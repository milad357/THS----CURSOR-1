        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-5">
              <Card hover className="gap-2">
                <h2 className="text-base md:text-lg font-semibold text-white">Camera Placement Consultation</h2>
              ...
              <Card hover className="gap-2">
                <h2 className="text-base md:text-lg font-semibold text-white">Blind-Spot Analysis</h2>
                <p className="text-sm text-text-muted leading-relaxed">
              ...
              <Card hover className="gap-2">
                <h2 className="text-base md:text-lg font-semibold text-white">Integration with Existing Systems</h2>
                <p className="text-sm text-text-muted leading-relaxed">
              ...
              <Card hover className="gap-2">
                <h2 className="text-base md:text-lg font-semibold text-white">Layered Security Planning</h2>
                <p className="text-sm text-text-muted leading-relaxed">
